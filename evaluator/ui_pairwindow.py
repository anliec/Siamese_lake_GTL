...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lb_score = QtWidgets.QLabel(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lb_score.sizePolicy().hasHeightForWidth())
        self.lb_score.setSizePolicy(sizePolicy)
        self.lb_score.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.lb_path1.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
    ...
    def retranslateUi(self, Form):
        ...
        self.lb_score.setText(_translate("Form", "score"))
