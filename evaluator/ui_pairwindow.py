...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lb_path11 = QtWidgets.QLabel(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lb_path11.sizePolicy().hasHeightForWidth())
        self.lb_path11.setSizePolicy(sizePolicy)
        self.lb_path11.setObjectName("lb_path11")
        self.verticalLayout_2.addWidget(self.lb_path11)
    ...
    def retranslateUi(self, Form):
        ...
        self.lb_path11.setText(_translate("Form", "path1"))
