...
from keras.layers import Input, Flatten, Dense, Dropout, Lambda, Concatenate, BatchNormalization
...
def get_siamese_model(src_model: Model, input_shape: tuple, add_batch_norm=False):
    input_a = Input(shape=input_shape)
    input_b = Input(shape=input_shape)
